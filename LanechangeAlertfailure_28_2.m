...
f=gcf;
saveas(f,'LanechangeAlertfailure_28_2_TTC.jpg');
...
f=gcf;
saveas(f,'LanechangeAlertfailure_28_2_FHTI.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'LanechangeAlertfailure_28_2','A1');
xlswrite('Functional_Safety_Scenarios',x_speed,'LanechangeAlertfailure_28_2','A2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'LanechangeAlertfailure_28_2','B2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'LanechangeAlertfailure_28_2','C2');
...
imageFolder = fileparts(which('LanechangeAlertfailure_28_2_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'LanechangeAlertfailure_28_2_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('LanechangeAlertfailure_28_2_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'LanechangeAlertfailure_28_2_FHTI.jpg');
