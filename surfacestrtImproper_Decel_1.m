...
f=gcf;
saveas(f,'surfacestrtImproper_Decel_1_TTC.jpg');
...
f=gcf;
saveas(f,'surfacestrtImproper_Decel_1_FHTI.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'surfacestrtImproper_Decel_1','A1');
xlswrite('Functional_Safety_Scenarios',x_speed,'surfacestrtImproper_Decel_1','A2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'surfacestrtImproper_Decel_1','B2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'surfacestrtImproper_Decel_1','C2');
...
imageFolder = fileparts(which('surfacestrtImproper_Decel_1_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'surfacestrtImproper_Decel_1_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('surfacestrtImproper_Decel_1_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'surfacestrtImproper_Decel_1_FHTI.jpg');
