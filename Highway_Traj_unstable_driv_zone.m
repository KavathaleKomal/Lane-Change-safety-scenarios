...
f=gcf;
saveas(f,'Highway_Traj_unstable_driv_zone_TTC.jpg');
...
f=gcf;
saveas(f,'Highway_Traj_unstable_driv_zone_FHTI.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'Highway_Traj_unstable_driv_zone','A1');
xlswrite('Functional_Safety_Scenarios',x_speed,'Highway_Traj_unstable_driv_zone','A2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'Highway_Traj_unstable_driv_zone','B2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'Highway_Traj_unstable_driv_zone','C2');
...
imageFolder = fileparts(which('Highway_Traj_unstable_driv_zone_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'Highway_Traj_unstable_driv_zone_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('Highway_Traj_unstable_driv_zone_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'Highway_Traj_unstable_driv_zone_FHTI.jpg');
