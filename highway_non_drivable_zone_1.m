...
f=gcf;
saveas(f,'highway_non-drivable zone_1_FHTI.jpg');
...
f=gcf;
saveas(f,'highway_non-drivable zone_1_TTC.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'highway_non-drivable zone_1','A1');
xlswrite('Functional_Safety_Scenarios',Str_Ang_Rate,'highway_non-drivable zone_1','A2');
xlswrite('Functional_Safety_Scenarios',x_speed,'highway_non-drivable zone_1','B2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'highway_non-drivable zone_1','C2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'highway_non-drivable zone_1','D2');
...
imageFolder = fileparts(which('highway_non-drivable zone_1_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'highway_non-drivable zone_1_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('highway_non-drivable zone_1_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'highway_non-drivable zone_1_FHTI.jpg');
