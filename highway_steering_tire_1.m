...
f=gcf;
saveas(f,'highway_steering_tire_1_TTC.jpg');
...
f=gcf;
saveas(f,'highway_steering_tire_1_FHTI.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'highway_steering_tire_1','A1');
xlswrite('Functional_Safety_Scenarios',x_speed,'highway_steering_tire_1','A2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'highway_steering_tire_1','B2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'highway_steering_tire_1','C2');
...
imageFolder = fileparts(which('highway_steering_tire_1_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'highway_steering_tire_1_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('highway_steering_tire_1_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'highway_steering_tire_1_FHTI.jpg');
