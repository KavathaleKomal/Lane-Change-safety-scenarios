...
f=gcf;
saveas(f,'surfacestrt_steering_tire_1_TTC.jpg');
...
f=gcf;
saveas(f,'surfacestrt_steering_tire_1_FHTI.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'surfacestrt_steering_tire_1','A1');
xlswrite('Functional_Safety_Scenarios',x_speed,'surfacestrt_steering_tire_1','A2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'surfacestrt_steering_tire_1','B2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'surfacestrt_steering_tire_1','C2');
...
imageFolder = fileparts(which('surfacestrt_steering_tire_1_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'surfacestrt_steering_tire_1_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('surfacestrt_steering_tire_1_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'surfacestrt_steering_tire_1_FHTI.jpg');
