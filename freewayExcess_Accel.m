...
f=gcf;
saveas(f,'freewayExcess_Accel_FHTI.jpg');
...
f=gcf;
saveas(f,'freewayExcess_Accel_TTC.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'freewayExcess_Accel','A1');
xlswrite('Functional_Safety_Scenarios',x_speed,'freewayExcess_Accel','A2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'freewayExcess_Accel','B2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'freewayExcess_Accel','C2');
...
imageFolder = fileparts(which('freewayExcess_Accel_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'freewayExcess_Accel_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('freewayExcess_Accel_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'freewayExcess_Accel_FHTI.jpg');
