...
f=gcf;
saveas(f,'surface_non-drivable zone_2_TTC.jpg');
...
f=gcf;
saveas(f,'surface_non-drivable zone_2_FHTI.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'surface_non-drivable zone_2','A1');
xlswrite('Functional_Safety_Scenarios',x_speed,'surface_non-drivable zone_2','A2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'surface_non-drivable zone_2','B2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'surface_non-drivable zone_2','C2');
...
imageFolder = fileparts(which('surface_non-drivable zone_2_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'surface_non-drivable zone_2_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('surface_non-drivable zone_2_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'surface_non-drivable zone_2_FHTI.jpg');
