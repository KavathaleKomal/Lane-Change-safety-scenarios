...
f=gcf;
saveas(f,'LanechangeAlertfailure_28_1_FHTI.jpg');
...
f=gcf;
saveas(f,'LanechangeAlertfailure_28_1_TTC.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'LanechangeAlertfailure_28_1','A1');
xlswrite('Functional_Safety_Scenarios',Str_Ang_Rate,'LanechangeAlertfailure_28_1','A2');
xlswrite('Functional_Safety_Scenarios',x_speed,'LanechangeAlertfailure_28_1','B2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'LanechangeAlertfailure_28_1','C2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'LanechangeAlertfailure_28_1','D2');
...
imageFolder = fileparts(which('LanechangeAlertfailure_28_1_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'LanechangeAlertfailure_28_1_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('LanechangeAlertfailure_28_1_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'LanechangeAlertfailure_28_1_FHTI.jpg');
