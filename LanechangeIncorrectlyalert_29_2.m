...
f=gcf;
saveas(f,'LanechangeIncorrectlyalert_29_2_TTC.jpg');
...
f=gcf;
saveas(f,'LanechangeIncorrectlyalert_29_2_FHTI.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'LanechangeIncorrectlyalert_29_2','A1');
xlswrite('Functional_Safety_Scenarios',x_speed,'LanechangeIncorrectlyalert_29_2','A2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'LanechangeIncorrectlyalert_29_2','B2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'LanechangeIncorrectlyalert_29_2','C2');
...
imageFolder = fileparts(which('LanechangeIncorrectlyalert_29_2_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'LanechangeIncorrectlyalert_29_2_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('LanechangeIncorrectlyalert_29_2_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'LanechangeIncorrectlyalert_29_2_FHTI.jpg');
