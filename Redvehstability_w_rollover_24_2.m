...
f=gcf;
saveas(f,'Redvehstability_w_rollover_24_2_FHTI.jpg');
...
f=gcf;
saveas(f,'Redvehstability_w_rollover_24_2_TTC.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'Redvehstability_w_rollover_24_2','A1');
xlswrite('Functional_Safety_Scenarios',Str_Ang_Rate,'Redvehstability_w_rollover_24_2','A2');
xlswrite('Functional_Safety_Scenarios',x_speed,'Redvehstability_w_rollover_24_2','B2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'Redvehstability_w_rollover_24_2','C2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'Redvehstability_w_rollover_24_2','D2');
...
imageFolder = fileparts(which('Redvehstability_w_rollover_24_2_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'Redvehstability_w_rollover_24_2_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('Redvehstability_w_rollover_24_2_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'Redvehstability_w_rollover_24_2_FHTI.jpg');
