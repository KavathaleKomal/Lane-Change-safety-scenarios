...
f=gcf;
saveas(f,'highway_non_steering_tire_2_TTC.jpg');
...
f=gcf;
saveas(f,'highway_non_steering_tire_2_FHTI.jpg');
...
xlswrite('Functional_Safety_Scenarios',data,'highway_non_steering_tire_2','A1');
xlswrite('Functional_Safety_Scenarios',x_speed,'highway_non_steering_tire_2','A2');
xlswrite('Functional_Safety_Scenarios',y_TTC,'highway_non_steering_tire_2','B2');
xlswrite('Functional_Safety_Scenarios',z_FHTI,'highway_non_steering_tire_2','C2');
...
imageFolder = fileparts(which('highway_non_steering_tire_2_TTC.jpg'));
imageFullFileName = fullfile(imageFolder, 'highway_non_steering_tire_2_TTC.jpg');
Shapes = oSheet.Shapes;
Shapes.AddPicture(imageFullFileName, 0, 1, 400, 20, 400, 300);

imageFolder1 = fileparts(which('highway_non_steering_tire_2_FHTI.jpg'));
imageFullFileName1 = fullfile(imageFolder, 'highway_non_steering_tire_2_FHTI.jpg');
